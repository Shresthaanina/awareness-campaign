...
class Campaign extends Model
{
    use HasFactory;
    protected $fillable = [
        'name','slug','excerpt','description','location','image','is_active','start_date','end_date','likes','created_by'
    ];
    ...
    public function create($data){
        ...
        $new_campiagn->is_active    = $data['is_active'] ?? '0';
    ...
    public function updateCampaign($data, $id){
        ...
        $saved_entry->is_active    = $data['is_active'] ?? $saved_entry->is_active;
